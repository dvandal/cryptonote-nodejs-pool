...
// TODO:                    recordShareData(miner, job, hashDiff.toString(), false, null, shareType);
                }
                else{
...
// TODO:                    recordShareData(miner, job, hashDiff.toString(), true, blockFastHash, shareType, blockTemplate);
                    jobRefresh();
                }
            }, config.childDaemon);
        }
