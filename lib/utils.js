 ...
 **/
console.log(config.poolServer.poolAddress)
var addressBase58Prefix = parseInt(cnUtil.address_decode(new Buffer(config.poolServer.poolAddress)));
var integratedAddressBase58Prefix = parseInt(config.poolServer.intAddressPrefix);
