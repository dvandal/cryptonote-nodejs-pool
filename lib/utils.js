...
function getAddressPrefix(address) {
    ...
    var addressPrefix = parseInt(cnUtil.address_decode(addressBuffer).toString());
    if (!addressPrefix) addressPrefix = parseInt(cnUtil.address_decode_integrated(addressBuffer).toString());
