...
var subAddressBase58Prefix = config.poolServer.subAddressPrefix ? parseInt(cnUtil.address_decode(new Buffer(config.poolServer.subAddressPrefix)).toString()) : "N/A";
